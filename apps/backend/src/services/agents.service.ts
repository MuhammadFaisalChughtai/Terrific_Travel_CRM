...
export class AgentsService {
    ...
    try {
      const agent = await prisma.agent.create({
        data: {
          ...
          basicSalary: data.basicSalary !== undefined && data.basicSalary !== null && data.basicSalary !== '' ? Number(data.basicSalary) : 0,
  ...
  async update(id: string, data: any) {
    ...
    const updateData: any = {
      ...
      basicSalary: data.basicSalary !== undefined ? (data.basicSalary !== null && data.basicSalary !== '' ? Number(data.basicSalary) : 0) : undefined,
